...
// Roles that see all submissions in history (not just their own)
export const ADMIN_ROLES = ['admin', 'boss_man'];
...
export const CATEGORY_TO_TRACKING = {
  ...
  GENL:  'General',
  DISP:  'Disposal',
  CEIL:  'Partition / Ceiling',
  TRANS: 'Worker Transport',
  VEHIC: 'Company Vehicle',
  MATL:  null,
  WTRP:  null,
  OTHR:  null,
};